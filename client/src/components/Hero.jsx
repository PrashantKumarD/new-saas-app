...
const Hero = () => {
  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex
     flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
        <div className='text-center mb-6 '>
            <h1 className='text-3xl sm:text-5xl font-bold md:text-6xl 2xl:text-7xl font-playfair mx-auto leading-[1.2]'>Create Awsome Content<br/> With <span className='text-primary'>AI Tools</span></h1>
            <p>Transorm your content creation with our suite of premium AI tools</p>
        </div>
